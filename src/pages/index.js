...
const projects = [
  ...
  {
    title: "pSSID (2023)",
    content:"pSSID engine is UMich ITS's latest effort to implement a full-stack web application for network analytics\
    in collaboration with perfSONAR, an open source networking project. UMich is actively contributing to the project to make it \
